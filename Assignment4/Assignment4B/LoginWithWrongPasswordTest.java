...
public class LoginWithWrongPassword {
  ...
  public void testLoginWithWrongPassword() throws Exception {
    ...
    driver.findElement(By.id("ap_password")).sendKeys("Helloworld");
    driver.findElement(By.id("signInSubmit")).click();
    try {
      assertEquals("There was a problem", driver.findElement(By.xpath("//div[@id='auth-error-message-box']/div/h4")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    try {
      assertEquals("Your password is incorrect", driver.findElement(By.xpath("//div[@id='auth-error-message-box']/div/div/ul/li/span")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
  }
