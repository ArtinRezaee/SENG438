...
public class LoginWithBadUserName {
  ...
  public void testLoginWithBadUserName() throws Exception {
    ...
    driver.findElement(By.id("ap_email")).sendKeys("www@email.co");
    ...
    try {
      assertEquals("We cannot find an account with that e-mail address", driver.findElement(By.xpath("//div[@id='auth-error-message-box']/div/div/ul/li/span")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
  }
