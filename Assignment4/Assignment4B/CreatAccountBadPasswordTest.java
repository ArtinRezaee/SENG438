...
public class CreatAccountBadPassword {
  ...
  @Test
  public void testCreatAccountBadPassword() throws Exception {
    ...
    driver.findElement(By.id("ap_password")).sendKeys("H");
    driver.findElement(By.id("ap_password_check")).click();
    driver.findElement(By.id("ap_password_check")).clear();
    driver.findElement(By.id("ap_password_check")).sendKeys("H");
    driver.findElement(By.id("continue")).click();
    try {
      assertEquals("Passwords must consist of at least 6 characters.", driver.findElement(By.xpath("//div[@id='auth-password-invalid-password-alert']/div/div")).getText());
    } catch (Error e) {
