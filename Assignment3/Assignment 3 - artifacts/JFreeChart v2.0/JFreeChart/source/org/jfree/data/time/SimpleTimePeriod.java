...
public class SimpleTimePeriod implements TimePeriod, Comparable, Serializable {
	...
	/**
	 * Tests this time period instance for equality with an arbitrary object. The
	 * object is considered equal if it is an instance of {@link TimePeriod} and it
	 * has the same start and end dates.
	 *
	 * @param obj
	 ...
	 *             if <code>obj</code> is not an instance of {@link TimePeriod}.
	 */
