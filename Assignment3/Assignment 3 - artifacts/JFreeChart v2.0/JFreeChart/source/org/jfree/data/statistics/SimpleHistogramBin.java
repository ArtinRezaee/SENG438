 ...
 * Contributor(s):   -;
 *
 * $Id: SimpleHistogramBin.java,v 1.4 2005/05/19 10:35:26 mungady Exp $
 *
 * Changes
 * -------
...
public class SimpleHistogramBin implements Comparable, Cloneable, PublicCloneable, Serializable {
	...
	/**
	 * Returns <code>true</code> if the specified value belongs in the bin, and
	...
	/**
	 * Returns <code>true</code> if this bin overlaps with the specified bin, and
	 * <code>false</code> otherwise.
	 * 
	 * @param bin
	 *            the other bin (<code>null</code> not permitted).
	 * 
	 * @return A boolean.
	 */
	 ...
	 *            the object.
	 * 
	 * @return An integer indicating the relative ordering of the this bin and the
	 *         given object.
	 */
