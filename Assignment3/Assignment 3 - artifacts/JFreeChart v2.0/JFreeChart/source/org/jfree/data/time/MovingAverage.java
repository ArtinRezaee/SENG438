 ...
 *
 * $Id: MovingAverage.java,v 1.5 2005/05/20 08:20:03 mungady Exp $
 *
 * Changes
 * -------
...
public class MovingAverage {
	 ...
	 */
	public static TimeSeriesCollection createMovingAverage(TimeSeriesCollection source, String suffix, int periodCount,
			int skip) {
	 ...
	 * given series. If the series is empty (contains zero items), the result is an
	 * empty series.
	 *
	 * @param source
	 *            the source series.
	 ...
	 * those points). If the series is empty (contains zero items), the result is an
	 * empty series.
	 * <p>
	 ...
	 * @return The dataset.
	 */
	public static XYDataset createMovingAverage(XYDataset source, String suffix, long period, final long skip) {
