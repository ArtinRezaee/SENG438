 ...
 *
 * $Id: TimeSeries.java,v 1.11 2005/11/17 12:45:41 mungady Exp $
 *
 * Changes
 * -------
...
public class TimeSeries extends Series implements Cloneable, Serializable {
	...
	public TimeSeries(String name, String domain, String range, Class timePeriodClass) {
		...
		this.maximumItemAge = Integer.MAX_VALUE;
	...
	/**
	 * Sets the number of time units in the 'history' for the series. This provides
	 * one mechanism for automatically dropping old data from the time series. For
	 * example, if a series contains daily data, you might set the history count to
	 * 30. Then, when you add a new data item, all data items more than 30 days
	 * older than the latest value are automatically dropped from the series.
	 *
	 * @param periods
	 ...
	 * oldest record in the series does not exceed maximumItemAge time periods.
	...
	public int hashCode() {
		...
		result = 29 * result + this.maximumItemAge;
		return result;
	}
