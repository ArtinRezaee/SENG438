 ...
 * Contributor(s):   -;
 *
 * $Id: DatasetChangeEvent.java,v 1.3 2005/03/28 19:44:04 mungady Exp $
 *
...
public class DatasetChangeEvent extends java.util.EventObject {
	 ...
	 * {@link org.jfree.chart.plot.Plot} class. The dataset can be <code>null</code>
	 * (in this case the source will be the {@link org.jfree.chart.plot.Plot}
	 * class).
	 *
	 * @param source
	 *            the source of the event.
	 * @param dataset
	 *            the dataset that generated the event (<code>null</code>
	 *            permitted).
	 */
	...
	/**
	 * Returns the dataset that generated the event. Note that the dataset may be
	 * <code>null</code> since adding a <code>null</code> dataset to a plot will
	 * generated a change event.
	 *
