 ...
 * Contributor(s):   -;
 *
 * $Id: TimeSeriesCollection.java,v 1.11 2005/12/14 14:30:45 mungady Exp $
 *
 * Changes
 * -------
...
public class TimeSeriesCollection extends AbstractIntervalXYDataset
	 ...
	 *
	 * @param zone
	 *            the timezone (<code>null</code> permitted, will use
	 ...
	 *
	 * @param series
	 *            the series (<code>null</code> permitted).
	 */
	 ...
	 *
	 * @param series
	 *            a series to add to the collection (<code>null</code> permitted).
	 * @param zone
	 *            the timezone (<code>null</code> permitted, will use
	 *            <code>TimeZone.getDefault()</code> in that case).
	 */
	 ...
	 * when the collection is used as an {@link org.jfree.data.xy.XYDataset}.
	 * 
	 ...
	 * the collection is used as an {@link XYDataset}, then sends a
	...
	/**
	 * Returns the series with the specified key, or <code>null</code> if there is
	 * no such series.
	 * 
	 * @param key
	...
	/**
	 * Returns the number of items in the specified series. This method is provided
	 * for convenience.
	 *
	 * @param series
	 *            the series index (zero-based).
