...
public abstract class DataUtilities {
	...
	/**
	 * Returns the sum of the values in one column of the supplied data table. With
	 * invalid input, a total of zero will be returned.
	 * 
	 * @param data
	...
	/**
	 * Returns the sum of the values in one row of the supplied data table. With
	 * invalid input, a total of zero will be returned.
	 * 
	 * @param data
	 *            the table of values (<code>null</code> not permitted).
	 ...
	 *
	 * @param data
	 *            An array of <code>double</code> primitives (<code>null</code> not
	 *            permitted).
	 *
	 ...
	 * percentage values for the data in another {@link KeyedValues} instance. The
	 * cumulative percentage is each value's cumulative sum's portion of the sum of
	 * all the values. <br>
	 * eg: <br>
	 * Input:<br>
	 * <br>
