 ...
 *
 * $Id: DefaultWindDataset.java,v 1.5 2005/05/20 08:20:03 mungady Exp $
 *
 * Changes
 * -------
...
public class DefaultWindDataset extends AbstractXYDataset implements WindDataset {
	...
	/**
	 * Constructs a dataset based on the specified data array. The array can contain
	 * multiple series, each series can contain multiple items, and each item is as
	 * follows:
	 * <ul>
	 * <li><code>data[series][item][0]</code> - the date (either a <code>Date</code>
	 * or a <code>Number</code> that is the milliseconds since 1-Jan-1970);</li>
	 * <li><code>data[series][item][1]</code> - the wind direction (1 - 12, like the
	 * numbers on a clock face);</li>
