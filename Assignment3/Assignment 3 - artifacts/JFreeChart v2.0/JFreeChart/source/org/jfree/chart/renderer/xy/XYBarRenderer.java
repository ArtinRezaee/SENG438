 ...
 *                   Bill Kelemen;
 *
 * $Id: XYBarRenderer.java,v 1.17 2005/12/12 14:11:32 mungady Exp $
 *
 * Changes
 * -------
...
public class XYBarRenderer extends AbstractXYItemRenderer
	...
	/**
	 * The shape used to represent a bar in each legend item (this should never be
	 * <code>null</code>).
	 */
	...
	/**
	 * Sets the base value for the bars and sends a {@link RendererChangeEvent} to
	 * all registered listeners. The base value is not used if the dataset's
	...
	/**
	 * Sets the flag that determines whether the y-interval from the dataset is used
	 * to calculate the length of each bar, and sends a {@link RendererChangeEvent}
	...
	public LegendItem getLegendItem(int datasetIndex, int series) {
		...
		if (xyplot != null) {
			...
			if (dataset != null) {
				...
				AttributedString attributedLabel = lg.generateAttributedLabel(dataset, series);
	...
	public void drawItem(Graphics2D g2, XYItemRendererState state, Rectangle2D dataArea, PlotRenderingInfo info,
		...
		if (isItemLabelVisible(series, item)) {
			drawItemLabel(g2, orientation, dataset, series, item, bar.getCenterX(), bar.getY(), value1 < 0.0);
		}
	 ...
	 * dataset. Since this renderer uses the x-interval in the dataset, this is
	 * taken into account for the range.
	 * 
	 * @param dataset
