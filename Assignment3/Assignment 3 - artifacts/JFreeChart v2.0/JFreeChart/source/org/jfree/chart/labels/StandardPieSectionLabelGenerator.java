 ...
 * Contributor(s):   -;
 *
 * $Id: StandardPieSectionLabelGenerator.java,v 1.5 2005/10/27 14:54:54 mungady Exp $
 *
 * Changes
 * -------
 ...
 */
public class StandardPieSectionLabelGenerator extends AbstractPieItemLabelGenerator
	...
	/**
	 * Returns the attributed label for a series, or <code>null</code> if none is
	 * defined.
	 * 
	 * @param series
	 *            the series index.
	 ...
	 * {@link #generateSectionLabel(PieDataset, Comparable)} will provide the
	 * fallback). Only certain attributes are recognised by the code that ultimately
	 * displays the labels:
	 * <ul>
