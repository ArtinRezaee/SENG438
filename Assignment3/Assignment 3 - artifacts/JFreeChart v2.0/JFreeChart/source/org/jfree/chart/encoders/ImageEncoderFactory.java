 ...
 *
 * $Id: ImageEncoderFactory.java,v 1.4 2005/11/01 17:04:16 mungady Exp $
 *
 * Changes
 * -------
...
public class ImageEncoderFactory {
	 ...
	 *            The image format required.
	 * @param quality
	 *            The quality to be set before returning.
	 * 
	 * @return The ImageEncoder or <code>null</code> if none available.
	 */
	 ...
	 *            The image format required.
	 * @param encodingAlpha
	 *            Sets whether alpha transparency should be encoded.
	 * 
	 * @return The ImageEncoder or <code>null</code> if none available.
	 */
