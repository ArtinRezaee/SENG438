 ...
 *
 * $Id: CategoryItemRenderer.java,v 1.10 2005/06/02 08:47:49 mungady Exp $
 *
 * Changes
 * -------
...
public interface CategoryItemRenderer extends LegendItemSource {
	 ...
	 * Usually this will be one, but some renderers may use a second or third pass
	 * to overlay items on top of things that were drawn in an earlier pass.
	 * 
	...
	/**
	 * Draws a line (or some other marker) to indicate a particular category on the
	 * domain axis.
	 *
	 * @param g2
	 *            the graphics device.
	 ...
	 */
	public void drawDomainMarker(Graphics2D g2, CategoryPlot plot, CategoryAxis axis, CategoryMarker marker,
