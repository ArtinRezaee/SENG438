 ...
 * Contributor(s):   -;
 *
 * $Id: PlotRenderingInfo.java,v 1.6 2005/11/02 13:13:14 mungady Exp $
 *
 * Changes
 * -------
...
public class PlotRenderingInfo implements Cloneable, Serializable {
	 ...
	 * (the "source" point). The source point will usually come from a mouse click
	 * on a {@link org.jfree.chart.ChartPanel}, and this method is then used to
	 * determine the subplot that contains the source point.
	 * 
	 * @param source
