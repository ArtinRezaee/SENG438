 ...
 *                   Tim Bardzil;
 *
 * $Id: BoxAndWhiskerRenderer.java,v 1.11 2005/12/12 14:11:32 mungady Exp $
 *
 * Changes
 * -------
...
public class BoxAndWhiskerRenderer extends AbstractCategoryItemRenderer
	...
	/**
	 * Initialises the renderer. This method gets called once at the start of the
	 * process of drawing a chart.
	 *
	 * @param g2
	 *            the graphics device.
	 * @param dataArea
	...
	public void drawItem(Graphics2D g2, CategoryItemRendererState state, Rectangle2D dataArea, CategoryPlot plot,
		...
		if (!(dataset instanceof BoxAndWhiskerCategoryDataset)) {
			throw new IllegalArgumentException("BoxAndWhiskerRenderer.drawItem() : the data should be of type "
