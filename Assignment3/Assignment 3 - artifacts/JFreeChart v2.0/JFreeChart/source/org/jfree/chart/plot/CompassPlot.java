 ...
 * @author Bryan Scott
 */
public class CompassPlot extends Plot implements Block, Cloneable, Serializable {
	...
	/**
	 * Sets the paint used to draw the circles, symbols and labels of the compass,
