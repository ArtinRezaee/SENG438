 ...
 *
 * $Id: ColorBar.java,v 1.7 2005/06/17 09:54:55 mungady Exp $
 *
 * Changes
 * -------
...
public class ColorBar implements Cloneable, Serializable {
	 ...
	 *
	 * @param g2
	 *            the graphics device. // * @param cursor the cursor.
	 * @param plotArea
	...
	public double draw(Graphics2D g2, // double cursor,
			Rectangle2D plotArea, Rectangle2D dataArea, Rectangle2D reservedArea, RectangleEdge edge) {
