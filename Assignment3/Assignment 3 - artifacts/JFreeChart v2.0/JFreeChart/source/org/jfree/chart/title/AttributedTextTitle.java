 ...
 */
public class AttributedTextTitle extends Title implements Serializable, Cloneable {
	 ...
	 *
	 * @param content
	 *            the title content (<code>null</code> not permitted).
	 */
	public AttributedTextTitle(AttributedCharacterIterator content) {
		this(content, DEFAULT_FONT, DEFAULT_PAINT, Title.DEFAULT_POSITION, Title.DEFAULT_HORIZONTAL_ALIGNMENT,
	 ...
	 *            the default paint.
	 */
	public AttributedTextTitle(AttributedCharacterIterator content, Font defaultFont, Paint defaultPaint) {
		this(content, defaultFont, defaultPaint, Title.DEFAULT_POSITION, Title.DEFAULT_HORIZONTAL_ALIGNMENT,
				Title.DEFAULT_VERTICAL_ALIGNMENT, Title.DEFAULT_PADDING);
	}
	 ...
	 *
	 * @param content
	 *            the content for the title (<code>null</code> not permitted).
	 * @param position
	 ...
	 */
	public AttributedTextTitle(AttributedCharacterIterator content, Font defaultFont, Paint defaultPaint,
			RectangleEdge position, HorizontalAlignment horizontalAlignment, VerticalAlignment verticalAlignment,
	 ...
	 *
	 * @param content
	 *            the content (<code>null</code> not permitted).
	 */
	...
	protected ArrangeResult arrangeNN(Graphics2D g2, ArrangeParams params) {
		...
		this.textBlock = ACIUtilities.createTextBlock(this.content, this.defaultFont, this.defaultPaint,
				this.lineAlignment);
	...
	protected ArrangeResult arrangeFF(Graphics2D g2, double fixedWidth, double fixedHeight, ArrangeParams params) {
		...
		if (messages != null) {
			...
			if (size.width > fixedWidth) {
				messages.add(new Message(this, "Text too wide to fit without clipping."));
			}
			if (size.height > fixedHeight) {
				messages.add(new Message(this, "Text too tall to fit without clipping."));
			}
		}
