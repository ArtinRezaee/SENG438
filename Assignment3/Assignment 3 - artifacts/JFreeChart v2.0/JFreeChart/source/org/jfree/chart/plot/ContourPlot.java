 ...
 *                   Nicolas Brodu;
 *
 * $Id: ContourPlot.java,v 1.19 2005/09/01 09:03:24 mungady Exp $
 *
 * Changes
 * -------
...
public class ContourPlot extends Plot
	...
	public void draw(Graphics2D g2, Rectangle2D plotArea, Point2D anchor, PlotState parentState,
		...
		if (this.domainAxis != null) {
			this.domainAxis.draw(g2, adjustedPlotArea, RectangleEdge.BOTTOM, info);
		}

		if (this.rangeAxis != null) {
			this.rangeAxis.draw(g2, adjustedPlotArea, RectangleEdge.LEFT, info);
		}
	...
	public void handleClick(int x, int y, PlotRenderingInfo info) {
		 ...
		 * 
		 * hva.setAnchorValue(hvalue); setDomainCrosshairValue(hvalue); }
		 * 
		 * // set the anchor value for the vertical axis... ValueAxis vva =
		 * getRangeAxis(); if (vva != null) { double vvalue =
		 * vva.translateJava2DtoValue( (float) y, info.getDataArea() );
		 * vva.setAnchorValue(vvalue); setRangeCrosshairValue(vvalue); }
		 */
	}
	...
	public void drawDomainMarker(Graphics2D g2, ContourPlot plot, ValueAxis domainAxis, Marker marker,
		...
		if (marker instanceof ValueMarker) {
			...
			g2.setPaint(paint != null ? paint : Color.gray);
	...
	/**
	 * Multiplies the range on the domain axis/axes by the specified factor (to be
	 * implemented).
	 * 
	 * @param x
