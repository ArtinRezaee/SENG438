 ...
 *
 * $Id: AbstractRenderer.java,v 1.23 2005/06/17 09:24:36 mungady Exp $
 *
 * Changes:
 * --------
...
public abstract class AbstractRenderer implements Cloneable, Serializable {
	...
	/**
	 * A list of flags that controls whether or not each series is visible in the
	 * legend.
	 */
	...
	/**
	 * The default flag that controls whether or not entities are generated. This
	 * flag is used when both the above flags return null.
	 */
	...
	/**
	 * Returns a boolean that indicates whether or not the specified item should be
	 * drawn (this is typically used to hide an entire series).
	 * 
	 * @param series
	 *            the series index.
	 * @param item
	 ...
	 * {@link RendererChangeEvent} to all registered listeners. This flag overrides
	 * the per series and default settings - you must set it to <code>null</code> if
	 * you want the other settings to apply.
	 * 
	 * @param visible
	...
	/**
	 * Sets the flag that controls whether a series is visible and, if requested,
	...
	/**
	 * Returns <code>true</code> if the series should be shown in the legend, and
	 ...
	 * This flag overrides the per series and default settings - you must set it to
	 * <code>null</code> if you want the other settings to apply.
	 * 
	 * @return The flag (possibly <code>null</code>).
	 */
	...
	/**
	 * Sets the flag that controls the visibility of ALL series in the legend and
	 * sends a {@link RendererChangeEvent} to all registered listeners. This flag
	 * overrides the per series and default settings - you must set it to
	 * <code>null</code> if you want the other settings to apply.
	 * 
	 * @param visible
	...
	/**
	 * Sets the flag that controls whether a series is visible in the legend and, if
	 ...
	 * implementation passes control to the {@link #getSeriesFillPaint(int)} method
	...
	/**
	 * Sets the paint used for a series fill and sends a {@link RendererChangeEvent}
	 ...
	 * passes control to the {@link #getSeriesOutlineStroke(int)} method. You can
	...
	/**
	 * Returns the flag that controls whether or not chart entities are created for
	 * the items in ALL series. This flag overrides the per series and default
	...
	/**
	 * Sets the flag that controls whether or not chart entities are created for the
	 * items in ALL series, and sends a {@link RendererChangeEvent} to all
	 * registered listeners. This flag overrides the per series and default settings
	 * - you must set it to <code>null</code> if you want the other settings to
	 * apply.
	 * 
	 * @param create
	 *            the flag (<code>null</code> permitted).
	...
	/**
	 * Sets the flag that controls whether entities are created for a series, and
	 * sends a {@link RendererChangeEvent} to all registered listeners.
	 *
	 * @param series
	 *            the series index (zero-based).
	...
	/**
	 * Sets the flag that controls whether entities are created for a series and, if
	 * requested, sends a {@link RendererChangeEvent} to all registered listeners.
	 * 
	 * @param series
	 *            the series index.
	...
	/**
	 * Sets the base flag that controls whether entities are created for a series,
	 ...
	 * dataset as a listener. Most applications won't need to call this method, it
	 * exists mainly for use by unit testing code.
	 * 
	 * @param listener
	 *            the listener.
	 * 
