 ...
 *
 * $Id: ImageMapUtilities.java,v 1.3 2005/03/04 11:53:05 mungady Exp $
 *
 * Changes
 * -------
...
public class ImageMapUtilities {
	...
	public static void writeImageMap(PrintWriter writer, String name, ChartRenderingInfo info) throws IOException {
		...
		ImageMapUtilities.writeImageMap(writer, name, info, new StandardToolTipTagFragmentGenerator(),
