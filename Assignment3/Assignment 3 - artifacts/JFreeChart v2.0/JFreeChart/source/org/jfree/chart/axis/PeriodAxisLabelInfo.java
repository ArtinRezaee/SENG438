 ...
 * Contributor(s):   -;
 *
 * $Id: PeriodAxisLabelInfo.java,v 1.7 2005/06/17 10:07:30 mungady Exp $
 *
 * Changes
 * -------
...
public class PeriodAxisLabelInfo implements Cloneable, Serializable {
	...
	/** Controls the gaps around the band - never <code>null</code>. */
	 ...
	 * 
	 * @param periodClass
	 *            the subclass of {@link RegularTimePeriod} to use
	 *            (<code>null</code> not permitted).
	 * @param dateFormat
	 *            the date format (<code>null</code> not permitted).
	 */
	public PeriodAxisLabelInfo(Class periodClass, DateFormat dateFormat) {
		this(periodClass, dateFormat, DEFAULT_INSETS, DEFAULT_FONT, DEFAULT_LABEL_PAINT, true, DEFAULT_DIVIDER_STROKE,
	 ...
	 *            the date format (<code>null</code> not permitted).
	 * @param padding
	 *            controls the space around the band (<code>null</code> not
	 *            permitted).
	 * @param labelFont
	 *            the label font (<code>null</code> not permitted).
	 * @param labelPaint
	 *            the label paint (<code>null</code> not permitted).
	 * @param drawDividers
	 *            a flag that controls whether dividers are drawn.
	 * @param dividerStroke
	 *            the stroke used to draw the dividers (<code>null</code> not
	 *            permitted).
	 * @param dividerPaint
	 *            the paint used to draw the dividers (<code>null</code> not
	 *            permitted).
	 */
	public PeriodAxisLabelInfo(Class periodClass, DateFormat dateFormat, RectangleInsets padding, Font labelFont,
			Paint labelPaint, boolean drawDividers, Stroke dividerStroke, Paint dividerPaint) {
		if (periodClass == null) {
	...
	/**
	 * Creates a time period that includes the specified millisecond, assuming the
	 * given time zone.
	 * 
	 * @param millisecond
	 *            the time.
