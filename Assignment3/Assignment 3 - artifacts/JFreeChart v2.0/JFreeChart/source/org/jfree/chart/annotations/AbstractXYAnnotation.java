...
public abstract class AbstractXYAnnotation implements XYAnnotation {
	 ...
	 *            information.
	 */
	public abstract void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea, ValueAxis domainAxis,
	 ...
	 * 
	 * @param info
	 *            the plot rendering info (<code>null</code> permitted).
	 * @param hotspot
	 *            the hotspot area.
	 * @param rendererIndex
	 *            the renderer index.
	 ...
	 *            the URL text.
	 */
	protected void addEntity(PlotRenderingInfo info, Shape hotspot, int rendererIndex, String toolTipText,
			String urlText) {
		if (info == null) {
			return;
		}
