 ...
 *                   Xavier Poinsard;
 *
 * $Id: ChartUtilities.java,v 1.4 2005/03/28 19:38:39 mungady Exp $
 *
 * Changes
 * -------
...
public abstract class ChartUtilities {
	...
	/**
	 * Writes a chart to an output stream in JPEG format. Please note that JPEG is a
	 * poor format for chart images, use PNG if possible.
	 * 
	 * @param out
	 *            the output stream (<code>null</code> not permitted).
	 * @param chart
	...
	public static String getImageMap(String name, ChartRenderingInfo info) {
		return ImageMapUtilities.getImageMap(name, info, new StandardToolTipTagFragmentGenerator(),
				new StandardURLTagFragmentGenerator());
	}
