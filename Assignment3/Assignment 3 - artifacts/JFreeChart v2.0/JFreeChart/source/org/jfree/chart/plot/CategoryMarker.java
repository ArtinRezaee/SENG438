 ...
 *
 * $Id: CategoryMarker.java,v 1.2 2005/08/19 11:33:38 mungady Exp $
 *
 * Changes
 * -------
...
public class CategoryMarker extends Marker implements Cloneable, Serializable {
	...
	/**
	 * Returns the flag that controls whether the marker is drawn as a region or a
	 * line.
	 * 
	 * @return A line.
	 */
	...
	/**
	 * Sets the flag that controls whether the marker is drawn as a region or as a
	 * line.
	 * 
	 * @param drawAsLine
	 *            the flag.
