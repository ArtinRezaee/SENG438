 ...
 * Contributor(s):   -;
 *
 * $Id: EntityBlockParams.java,v 1.1 2005/04/20 22:19:11 mungady Exp $
 *
 * Changes:
 * --------
...
public interface EntityBlockParams {
	...
	/**
	 * Returns a flag that controls whether or not the block should return entities
	 * for the items it draws.
	 * 
	 * @return A boolean.
	 */
