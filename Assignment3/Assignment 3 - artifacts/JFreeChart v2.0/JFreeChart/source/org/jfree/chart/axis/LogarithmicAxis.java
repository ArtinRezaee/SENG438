 ...
 *                   Scott Sams;
 *
 * $Id: LogarithmicAxis.java,v 1.11 2005/05/19 13:58:11 mungady Exp $
 *
 * Changes
 * -------
...
public class LogarithmicAxis extends NumberAxis {
	 ...
	 * to use regular numeric tick labels.
	 *
	 * @param flgVal
	 ...
	 *
	 * @return <code>true</code> for "1e#"-style tick labels, <code>false</code> for
	 ...
	 *
	 * @return <code>true</code> for "10^n"-style tick labels, <code>false</code>
	 *         for "1e#"-style or regular numeric tick labels.
	 */
	 ...
	 *
	 * @param flag
	 *            <code>true</code> to make the 'autoAdjustRange()' method select
	 *            the next "10^n" values, <code>false</code> to not.
	 */
	 ...
	 *
	 * @return <code>true</code> if the 'autoAdjustRange()' method will select the
	 *         next "10^n" values, <code>false</code> if not.
	 */
