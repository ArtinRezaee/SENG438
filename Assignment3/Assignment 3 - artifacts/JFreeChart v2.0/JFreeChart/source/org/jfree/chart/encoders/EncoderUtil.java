 ...
 * Contributor(s):   -;
 *
 * $Id: EncoderUtil.java,v 1.3 2005/03/28 19:38:57 mungady Exp $
 *
 * Changes
 * -------
...
public class EncoderUtil {
	 ...
	 *            The {@link ImageFormat} to use.
	 * @param encodeAlpha
	 *            Whether to encode alpha transparency (not supported by all
	 *            ImageEncoders).
	 * @return The byte[] that is the encoded image.
	 * @throws IOException
	 */
	 ...
	 *            The {@link ImageFormat} to use.
	 * @param quality
	 *            The quality to use for the image encoding (not supported by all
	 *            ImageEncoders).
	 * @return The byte[] that is the encoded image.
	 * @throws IOException
	 */
