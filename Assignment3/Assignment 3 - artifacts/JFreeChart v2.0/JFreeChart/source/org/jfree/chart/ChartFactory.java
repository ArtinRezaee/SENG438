 ...
 *                   Benoit Xhenseval;
 *
 * $Id: ChartFactory.java,v 1.27 2006/01/26 12:03:16 mungady Exp $
 *
 * Changes
 * -------
...
public abstract class ChartFactory {
	...
	public static JFreeChart createPieChart(String title, PieDataset dataset, boolean legend, boolean tooltips,
		...
		plot.setMargin(new RectangleInsets(5.0, 5.0, 5.0, 5.0));
		if (tooltips) {
			plot.setToolTipGenerator(
					new StandardPieToolTipGenerator(StandardPieToolTipGenerator.DEFAULT_SECTION_LABEL_FORMAT));
		}
		if (urls) {
	 ...
	 * same key in <code>previousDataset</code>. ie if value1 > value2 then the
	 * section will be in green (unless <code>greenForIncrease</code> is
	 * <code>false</code>, in which case it would be <code>red</code>). Each section
	 * can have a shade of red or green as the difference can be tailored between 0%
	 * (black) and percentDiffForMaxScale% (bright red/green).
	 * <p>
	 * For instance if <code>percentDiffForMaxScale</code> is 10 (10%), a difference
	 * of 5% will have a half shade of red/green, a difference of 10% or more will
	 * have a maximum shade/brightness of red/green.
	 * <P>
	 * The chart object returned by this method uses a {@link PiePlot} instance as
	 * the plot.
	 * <p>
	...
	public static JFreeChart createPieChart(String title, PieDataset dataset, PieDataset previousDataset,
		...
		PiePlot plot = new PiePlot(dataset);
		plot.setLabelGenerator(new StandardPieSectionLabelGenerator());
		plot.setMargin(new RectangleInsets(0.0, 5.0, 5.0, 5.0));
	 ...
	 * <P>
	 * The chart object returned by this method uses a {@link RingPlot} instance as
	 * the plot.
	 *
	 * @param title
	 *            the chart title (<code>null</code> permitted).
	...
	/**
	 * Creates a chart that displays multiple pie plots. The chart object returned
	 * by this method uses a {@link MultiplePiePlot} instance as the plot.
	 *
	 * @param title
	 *            the chart title (<code>null</code> permitted).
	 * @param dataset
	...
	/**
	 * Creates a 3D pie chart using the specified dataset. The chart object returned
	 * by this method uses a {@link PiePlot3D} instance as the plot.
	 *
	 * @param title
	 *            the chart title (<code>null</code> permitted).
	 * @param dataset
	 ...
	 * the domain axis, a {@link NumberAxis} as the range axis, and a
	...
	/**
	 * Creates a stacked bar chart with default settings. The chart object returned
	 * by this method uses a {@link CategoryPlot} instance as the plot, with a
	 * {@link CategoryAxis} for the domain axis, a {@link NumberAxis} as the range
	 * axis, and a {@link StackedBarRenderer} as the renderer.
	 *
	 * @param title
	 *            the chart title (<code>null</code> permitted).
	...
	/**
	 * Creates a stacked bar chart with a 3D effect and default settings. The chart
	 * object returned by this method uses a {@link CategoryPlot} instance as the
	 * plot, with a {@link CategoryAxis3D} for the domain axis, a
	 ...
	 * {@link CategoryAxis} for the domain axis, a {@link NumberAxis} as the range
	 * axis, and an {@link AreaRenderer} as the renderer.
	 *
	 * @param title
	 *            the chart title (<code>null</code> permitted).
	 * @param categoryAxisLabel
	...
	/**
	 * Creates a stacked area chart with default settings. The chart object returned
	 * by this method uses a {@link CategoryPlot} instance as the plot, with a
	 * {@link CategoryAxis} for the domain axis, a {@link NumberAxis} as the range
	 * axis, and a {@link StackedAreaRenderer} as the renderer.
	 *
	 * @param title
	 *            the chart title (<code>null</code> permitted).
	 * @param categoryAxisLabel
	...
	/**
	 * Creates a line chart with default settings. The chart object returned by this
	 * method uses a {@link CategoryPlot} instance as the plot, with a
	 * {@link CategoryAxis} for the domain axis, a {@link NumberAxis} as the range
	 * axis, and a {@link LineAndShapeRenderer} as the renderer.
	 *
	 * @param title
	 *            the chart title (<code>null</code> permitted).
	 * @param categoryAxisLabel
	 ...
	 * required. The chart object returned by this method uses a
	 * {@link CategoryPlot} instance as the plot, with a {@link CategoryAxis} for
	 * the domain axis, a {@link DateAxis} as the range axis, and a
	...
	/**
	 * Creates a waterfall chart. The chart object returned by this method uses a
	 * {@link CategoryPlot} instance as the plot, with a {@link CategoryAxis} for
	 * the domain axis, a {@link NumberAxis} as the range axis, and a
	...
	/**
	 * Creates a scatter plot with default settings. The chart object returned by
	 * this method uses an {@link XYPlot} instance as the plot, with a
	...
	/**
	 * Creates a stacked XY area plot. The chart object returned by this method uses
	 * an {@link XYPlot} instance as the plot, with a {@link NumberAxis} for the
	 * domain axis, a {@link NumberAxis} as the range axis, and a
	 * {@link StackedXYAreaRenderer} as the renderer.
	 *
	 * @param title
	 *            the chart title (<code>null</code> permitted).
	 * @param xAxisLabel
