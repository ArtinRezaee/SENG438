 ...
 *
 * $Id: CombinedDomainCategoryPlot.java,v 1.10 2005/06/17 09:46:56 mungady Exp $
 *
 * Changes:
 * --------
...
public class CombinedDomainCategoryPlot extends CategoryPlot
	 ...
	 *
	 * @param domainAxis
	 *            the shared domain axis (<code>null</code> not permitted).
	 */
	...
	/**
	 * Adds a subplot to the combined chart and sends a {@link PlotChangeEvent} to
	...
	public void add(CategoryPlot subplot, int weight) {
		...
		subplot.setMargin(new RectangleInsets(0.0, 0.0, 0.0, 0.0));
	...
	public void draw(Graphics2D g2, Rectangle2D area, Point2D anchor, PlotState parentState, PlotRenderingInfo info) {
		...
		area.setRect(area.getX() + margin.getLeft(), area.getY() + margin.getTop(),
				area.getWidth() - margin.getLeft() - margin.getRight(),
				area.getHeight() - margin.getTop() - margin.getBottom());
