 ...
 *
 * $Id: ImageTitle.java,v 1.11 2005/07/19 14:20:45 mungady Exp $
 *
...
public class ImageTitle extends Title {
	...
	public ArrangeResult arrange(Graphics2D g2, RectangleConstraint constraint, ArrangeParams params) {
		...
		if (result != null) {
			result.setSize(calculateTotalWidth(image.getWidth(null)), calculateTotalHeight(image.getHeight(null)));
		} else {
			result = new ArrangeResult(calculateTotalWidth(image.getWidth(null)),
					calculateTotalHeight(image.getHeight(null)), null);
		}
		return result;
	}
	...
	protected Size2D drawHorizontal(Graphics2D g2, Rectangle2D chartArea) {
		...
		if (horizontalAlignment == HorizontalAlignment.CENTER) {
			startX = chartArea.getX() + leftSpace + chartArea.getWidth() / 2.0 - this.width / 2.0;
	...
	protected Size2D drawVertical(Graphics2D g2, Rectangle2D chartArea) {
		...
		if (alignment == VerticalAlignment.CENTER) {
			startY = chartArea.getMinY() + topSpace + chartArea.getHeight() / 2.0 - this.height / 2.0;
