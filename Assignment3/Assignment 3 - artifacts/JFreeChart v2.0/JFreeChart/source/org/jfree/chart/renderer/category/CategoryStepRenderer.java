 ...
 *
 * $Id: CategoryStepRenderer.java,v 1.5 2005/05/19 14:01:46 mungady Exp $
 *
 * Changes
 * -------
...
public class CategoryStepRenderer extends AbstractCategoryItemRenderer
	...
	/**
	 * Sets the flag that controls whether or not the series steps are staggered and
	...
	public void drawItem(Graphics2D g2, CategoryItemRendererState state, Rectangle2D dataArea, CategoryPlot plot,
		 ...
		 * it due to time pressure. It shouldn't be hard to put back in.
		 * 
		 * // collect entity and tool tip information... if (state.getInfo() != null) {
