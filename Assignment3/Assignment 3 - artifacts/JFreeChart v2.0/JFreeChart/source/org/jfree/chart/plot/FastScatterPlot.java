 ...
 *
 * $Id: FastScatterPlot.java,v 1.13 2005/07/19 14:23:55 mungady Exp $
 *
...
public class FastScatterPlot extends Plot implements ValueAxisPlot, Zoomable, Cloneable, Serializable {
	...
	/**
	 * Sets the data array used by the plot and sends a {@link PlotChangeEvent} to
	 * all registered listeners.
	 * 
	 * @param data
	 *            the data array (<code>null</code> permitted).
	 */
	 ...
	 * visible. If the flag value is changed, a {@link PlotChangeEvent} is sent to
	 * all registered listeners.
	 *
	 * @param visible
	 *            the new value of the flag.
	...
	public void draw(Graphics2D g2, Rectangle2D plotArea, Point2D anchor, PlotState parentState,
		...
		// g2, dataArea.getMaxY(), plotArea, dataArea,
		// RectangleEdge.BOTTOM, info
		// );
		// }
		// if (this.rangeAxis != null) {
		// rangeAxisState = this.rangeAxis.draw(
		// g2, dataArea.getMinX(), plotArea, dataArea,
