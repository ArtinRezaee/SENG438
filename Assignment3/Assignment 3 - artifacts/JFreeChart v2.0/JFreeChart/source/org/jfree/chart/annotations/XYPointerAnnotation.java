 ...
 * Contributor(s):   -;
 *
 * $Id: XYPointerAnnotation.java,v 1.4 2005/05/19 15:41:53 mungady Exp $
 *
 * Changes:
 * --------
...
public class XYPointerAnnotation extends XYTextAnnotation implements Cloneable, PublicCloneable, Serializable {
	...
	public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea, ValueAxis domainAxis, ValueAxis rangeAxis,
		...
		Rectangle2D hotspot = TextUtilities.drawAlignedString(getText(), g2, (float) labelX, (float) labelY,
				getTextAnchor());
