 ...
 *                   Daniel Gredler;
 *
 * $Id: PlotPropertyEditPanel.java,v 1.9 2005/09/30 15:00:21 mungady Exp $
 *
...
public class PlotPropertyEditPanel extends JPanel implements ActionListener {
	...
	public PlotPropertyEditPanel(Plot plot) {
		...
		this.plotInsets = plot.getMargin();
	...
	/**
	 * Allow the user to modify whether or not lines are drawn between data points
