 ...
 *                   Center);
 *
 * $Id: StandardXYItemRenderer.java,v 1.21 2005/12/12 14:11:32 mungady Exp $
 *
 * Changes:
 * --------
...
public class StandardXYItemRenderer extends AbstractXYItemRenderer
	...
	/**
	 * The shape that is used to represent a line in the legend. This should never
		...
		if (dataset != null) {
			if (getItemVisible(series, 0)) {
				...
				if (attributedLabel != null) {
					result = new LegendItem(attributedLabel, description, toolTipText, urlText, this.baseShapesVisible,
							shape, shapeFilled, paint, !shapeFilled, paint, lineStroke, this.plotLines, this.legendLine,
