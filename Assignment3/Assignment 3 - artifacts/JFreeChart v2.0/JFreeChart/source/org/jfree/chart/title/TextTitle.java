...
public class TextTitle extends Title implements Serializable, Cloneable, PublicCloneable {
	...
	public TextTitle(String text) {
		this(text, TextTitle.DEFAULT_FONT, TextTitle.DEFAULT_TEXT_PAINT, Title.DEFAULT_POSITION,
				Title.DEFAULT_HORIZONTAL_ALIGNMENT, Title.DEFAULT_VERTICAL_ALIGNMENT, Title.DEFAULT_PADDING);
	}
	...
	protected ArrangeResult arrangeNN(Graphics2D g2, ArrangeParams params) {
		...
		this.content = TextUtilities.createTextBlock(this.text, this.font, this.paint, Float.MAX_VALUE,
		...
		if (messages != null) {
			if (w < naturalSize.getWidth()) {
				messages.add(new Message(this, "Prespecified width is too small."));
			}
			if (h < naturalSize.getHeight()) {
				messages.add(new Message(this, "Prespecified height is too small."));
			}
		}
	...
	protected ArrangeResult arrangeFN(Graphics2D g2, double fixedWidth, ArrangeParams params) {
		...
		g2.setFont(this.font);
		this.content = TextUtilities.createTextBlock(this.text, this.font, this.paint, maxWidth,
				new G2TextMeasurer(g2));
	...
	protected ArrangeResult arrangeFR(Graphics2D g2, double fixedWidth, Range heightRange, ArrangeParams params) {
		...
		if (heightRange.contains(s.getHeight())) {
			...
			return arrangeFF(g2, fixedWidth, heightRange.constrain(s.getHeight()), params);
		}
	}
	...
	protected ArrangeResult arrangeFF(Graphics2D g2, double fixedWidth, double fixedHeight, ArrangeParams params) {
		...
		g2.setFont(this.font);
		this.content = TextUtilities.createTextBlock(this.text, this.font, this.paint, (float) fixedWidth,
				new G2TextMeasurer(g2));
	...
	protected ArrangeResult arrangeRN(Graphics2D g2, Range widthRange, ArrangeParams params) {
		...
		if (widthRange.contains(contentSize.getWidth())) {
			...
			// TODO: review the logging requirement here
			return arrangeFN(g2, widthRange.constrain(contentSize.getWidth()), params);
		}
	}
