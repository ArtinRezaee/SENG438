...
public class XYPlotWrapper extends AbstractContentBlock implements Block {
	...
	public ArrangeResult arrange(Graphics2D g2, RectangleConstraint constraint, ArrangeParams params) {
		...
		result.setSize(new Size2D(this.plot.calculateTotalWidth(contentSize.getWidth()),
	...
	protected ArrangeResult arrangeNN(Graphics2D g2, ArrangeParams params) {
		...
		return new ArrangeResult(new Size2D(this.plot.trimToContentWidth(width), this.plot.trimToContentHeight(height)),
				null);
