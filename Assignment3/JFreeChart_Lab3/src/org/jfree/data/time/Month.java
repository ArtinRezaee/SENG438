 ...
 * Contributor(s):   -;
 *
 * $Id: Month.java,v 1.8 2005/11/02 13:33:44 mungady Exp $
 *
 * Changes
 * -------
 ...
 * 02-Nov-2005 : Fixed bug 1345383 (argument check in constructor) (DG);
 *
 */
...
public class Month extends RegularTimePeriod implements Serializable {
	...
	/**
	 * Constructs a new month instance, based on a date/time and the default time
	 * zone.
	 *
	 * @param time
	 *            the date/time.
