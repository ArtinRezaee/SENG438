...
public class DefaultHighLowDataset extends AbstractXYDataset implements OHLCDataset {
	 ...
	 *            the volume values.
	 */
	public DefaultHighLowDataset(Comparable seriesKey, Date[] date, double[] high, final double[] low, double[] open,
			final double[] close, double[] volume) {
	 ...
	 * <code>Long</code> instance generated from the underlying <code>Date</code>
	 * object.
	 *
	 * @param series
