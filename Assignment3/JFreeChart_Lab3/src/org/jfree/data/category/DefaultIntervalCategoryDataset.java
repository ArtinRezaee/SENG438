 ...
 *
 * $Id: DefaultIntervalCategoryDataset.java,v 1.10 2005/10/25 15:48:57 mungady Exp $
 *
 * Changes
 * -------
...
public class DefaultIntervalCategoryDataset extends AbstractSeriesDataset implements IntervalCategoryDataset {
		...
		if (starts != null && ends != null) {
			...
			if (seriesCount > 0) {
				...
				if (categoryCount != ends[0].length) {
					String errMsg = "DefaultIntervalCategoryDataset: the " + "number of categories in the start value "
							+ "dataset does not match the number of " + "categories in the end value dataset.";
					throw new IllegalArgumentException(errMsg);
				}
				if (categoryKeys != null) {
					if (categoryKeys.length != categoryCount) {
						throw new IllegalArgumentException("The number of category keys does "
	 ...
	 *            the required category.
	 *
	 * @return The start data value for one category in a series (possibly
	 *         <code>null</code>).
	 */
	...
	/**
	 * Returns the number of categories in the dataset. This method is part of the
