 ...
 * Contributor(s):   -;
 *
 * $Id: BoxAndWhiskerItem.java,v 1.5 2005/05/19 10:35:26 mungady Exp $
 *
 * Changes
 * -------
...
public class BoxAndWhiskerItem implements Serializable {
	 ...
	 */
	public BoxAndWhiskerItem(Number mean, Number median, Number q1, Number q3, Number minRegularValue,
			Number maxRegularValue, Number minOutlier, Number maxOutlier, List outliers) {
