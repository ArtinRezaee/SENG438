 ...
 * Contributor(s):   -;
 *
 * $Id: KeyToGroupMap.java,v 1.8 2005/08/18 13:52:22 mungady Exp $
 *
 * Changes
 * -------
...
public class KeyToGroupMap implements Cloneable, PublicCloneable, Serializable {
	 ...
	 * The returned list is independent of the map, so altering the list will have
	 * no effect.
	 * 
	 ...
	 *            the key (<code>null</code> not permitted).
	 * @param group
	 *            the group (<code>null</code> permitted, clears any existing
	 *            mapping).
	 */
	...
	/**
	 * Returns the number of keys mapped to the specified group. This method won't
	 * always return an accurate result for the default group, since explicit
	 * mappings are not required for this group.
	 * 
	 * @param group
