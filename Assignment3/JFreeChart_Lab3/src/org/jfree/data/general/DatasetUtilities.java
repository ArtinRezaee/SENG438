 ...
 *
 * $Id: DatasetUtilities.java,v 1.20 2005/09/30 10:23:21 mungady Exp $
 *
...
public final class DatasetUtilities {
	 ...
	 * Creates a new pie dataset based on the supplied dataset, but modified by
	 * aggregating all the low value items (those whose value is lower than the
	 * <code>percentThreshold</code>) into a single item. The aggregated items are
	 * assigned the specified key. Aggregation only occurs if there are at least
	 * <code>minItems</code> items to aggregate.
	 *
	 * @param source
	 *            the source dataset (<code>null</code> not permitted).
	 * @param key
	 ...
	 *            x-interval or just the x-value is used to determine the overall
	 *            range.
	 * 
	 * @return The range (possibly <code>null</code>).
	 */
	 ...
	 *            the dataset (<code>null</code> not permitted).
	 * @param includeInterval
	 *            a flag that determines whether or not the y-interval is taken into
	 *            account.
	 * 
	 * @return The range (possibly <code>null</code>).
	 */
	...
	/**
	 * Returns the range of values in the range for the dataset. This method is the
	 * partner for the {@link #findDomainBounds(XYDataset)} method.
	 *
	 * @param dataset
	 *            the dataset (<code>null</code> not permitted).
	 *
	...
	/**
	 * Finds the minimum domain (or X) value for the specified dataset. This is easy
	 * if the dataset implements the {@link DomainInfo} interface (a good idea if
	 * there is an efficient way to determine the minimum value). Otherwise, it
	...
	/**
	 * Returns the maximum domain value for the specified dataset. This is easy if
	 * the dataset implements the {@link DomainInfo} interface (a good idea if there
	 * is an efficient way to determine the maximum value). Otherwise, it involves
	 * iterating over the entire data-set. Returns <code>null</code> if all the data
	...
	/**
	 * Returns the minimum range value for the specified dataset. This is easy if
	 * the dataset implements the {@link RangeInfo} interface (a good idea if there
	 * is an efficient way to determine the minimum value). Otherwise, it involves
	 * iterating over the entire data-set. Returns <code>null</code> if all the data
	 * values in the dataset are <code>null</code>.
	 *
	 * @param dataset
	...
	/**
	 * Returns the maximum range value for the specified dataset. This is easy if
	 * the dataset implements the {@link RangeInfo} interface (a good idea if there
	 * is an efficient way to determine the maximum value). Otherwise, it involves
	 * iterating over the entire data-set. Returns <code>null</code> if all the data
	...
	/**
	 * Returns the minimum and maximum values for the dataset's range (y-values),
	...
	/**
	 * Returns the minimum and maximum values for the dataset's range, assuming that
	 * the series are stacked, using the specified base value.
	 *
	 * @param dataset
	 *            the dataset (<code>null</code> not permitted).
	 * @param base
