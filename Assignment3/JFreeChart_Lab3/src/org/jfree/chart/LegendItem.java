 ...
 *                   Luke Quinane;
 *
 * $Id: LegendItem.java,v 1.13 2005/12/12 14:11:31 mungady Exp $
 *
 ...
 * 01-Jul-2005 : Added attributedLabel (DG);
...
public class LegendItem implements Serializable {
	...
	/**
	 * The shape must be non-null for a LegendItem - if no shape is required, use
	 * this.
	 */
	private static final Shape UNUSED_SHAPE = new Line2D.Float();

	/**
	 * The stroke must be non-null for a LegendItem - if no stroke is required, use
	 * this.
	 */
	private static final Stroke UNUSED_STROKE = new BasicStroke(0.0f);

	/**
	 * Creates a legend item with a filled shape. The shape is not outlined, and no
	 * line is visible.
	 * 
	 * @param label
	 ...
	 *            permitted).
	 */
	public LegendItem(String label, String description, String toolTipText, String urlText, Shape shape,
			Paint fillPaint) {

		this(label, description, toolTipText, urlText, /* shape visible = */ true, shape, /* shape filled = */ true,
				fillPaint, /* shape outlined */ false, Color.black, UNUSED_STROKE, /* line visible */ false,
				UNUSED_SHAPE, UNUSED_STROKE, Color.black);
	...
	public LegendItem(String label, String description, String toolTipText, String urlText, Shape shape,
		...
		this(label, description, toolTipText, urlText, /* shape visible = */ true, shape, /* shape filled = */ true,
				fillPaint, /* shape outlined = */ true, outlinePaint, outlineStroke, /* line visible */ false,
				UNUSED_SHAPE, UNUSED_STROKE, Color.black);
	 ...
	 */
	public LegendItem(String label, String description, String toolTipText, String urlText, Shape line,
			Stroke lineStroke, Paint linePaint) {

		this(label, description, toolTipText, urlText, /* shape visible = */ false, UNUSED_SHAPE,
				/* shape filled = */ false, Color.black, /* shape outlined = */ false, Color.black, UNUSED_STROKE,
