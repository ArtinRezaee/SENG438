 ...
 * Contributor(s):   -;
 *
 * $Id: Block.java,v 1.6 2005/07/19 14:27:02 mungady Exp $
 *
 * Changes:
 * --------
...
public interface Block extends Drawable {
	 ...
	 * block size. In general, the size returned by this method is the preferred
	 * size for the block.
	 * 
	 * @param g2
	 *            the graphics device.
	 ...
	 * 
	 * @deprecated This doesn't provide a way to get messages out!!
	 */
