...
public class FlowArrangement implements Arrangement, Serializable {
	...
	protected ArrangeResult arrangeFN(BlockContainer container, Graphics2D g2, RectangleConstraint constraint,
		...
		return new ArrangeResult(new Size2D(constraint.getWidth(), y + maxHeight), null);
	}
	 ...
	 * @return The size following the arrangement.
	 */
	protected ArrangeResult arrangeRN(BlockContainer container, Graphics2D g2, RectangleConstraint constraint,
			ArrangeParams params) {
	 ...
	 *            optional parameters.
	 * 
	 * @return The result of the arrangement (including the size of the contained
	 *         blocks).
	 */
