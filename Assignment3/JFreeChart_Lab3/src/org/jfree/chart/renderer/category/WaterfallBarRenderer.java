 ...
 *
 * $Id: WaterfallBarRenderer.java,v 1.10 2005/06/17 09:24:15 mungady Exp $
 *
 * Changes
 * -------
 ...
 * {@link CategoryPlot} class. Note that the bar colors are defined using
 * special methods in this class - the inherited methods (for example,
...
public class WaterfallBarRenderer extends BarRenderer implements Cloneable, PublicCloneable, Serializable {
	 ...
	 *
	 * @param firstBarPaint
	 *            the color of the first bar (<code>null</code> not permitted).
	 * @param positiveBarPaint
	 *            the color for bars with positive values (<code>null</code> not
	 *            permitted).
	 * @param negativeBarPaint
	 *            the color for bars with negative values (<code>null</code> not
	 *            permitted).
	 * @param lastBarPaint
	 *            the color of the last bar (<code>null</code> not permitted).
	 */
