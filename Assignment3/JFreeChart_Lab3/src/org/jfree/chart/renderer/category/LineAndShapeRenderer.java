...
public class LineAndShapeRenderer extends AbstractCategoryItemRenderer
	...
	/**
	 * Returns the flag that controls whether the outline paint is used for shape
	 * outlines. If not, the regular series paint is used.
	 * 
	 * @return A boolean.
	 */
	...
	/**
	 * Returns the flag used to control whether or not the shape for an item is
	 * filled. The default implementation passes control to the
	...
	public LegendItem getLegendItem(int datasetIndex, int series) {
		...
		if (isSeriesVisible(series) && isSeriesVisibleInLegend(series)) {
			...
			return new LegendItem(label, description, toolTipText, urlText, shapeVisible, shape,
