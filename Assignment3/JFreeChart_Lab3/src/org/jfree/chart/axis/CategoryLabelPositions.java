 ...
 * Contributor(s):   -;
 *
 * $Id: CategoryLabelPositions.java,v 1.5 2005/05/19 13:58:11 mungady Exp $
 *
 * Changes
 * -------
...
public class CategoryLabelPositions implements Serializable {
	...
	public static CategoryLabelPositions createUpRotationLabelPositions(double angle) {
		return new CategoryLabelPositions(
				...
				new CategoryLabelPosition(RectangleAnchor.TOP, TextBlockAnchor.TOP_RIGHT, TextAnchor.TOP_RIGHT, -angle,
