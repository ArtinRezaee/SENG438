 ...
 *                   Daniel Gredler;
 *
 * $Id: TitlePropertyEditPanel.java,v 1.6 2005/05/03 10:11:23 mungady Exp $
 *
 ...
 * 31-Jan-2002 : Removed Title.java and StandardTitle.java.  Disabled some 
 *               methods in this class until support for AbstractTitle is 
 *               added (DG);
...
public class TitlePropertyEditPanel extends JPanel implements ActionListener {
	...
	/**
	 * Allow the user the opportunity to change whether the title is displayed on
	 * the chart or not.
	 */
	...
	/**
	 * If we are supposed to show the title, the controls are enabled. If we are not
	 * supposed to show the title, the controls are disabled.
	 */
