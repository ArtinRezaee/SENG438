 ...
 *                   Arnaud Lelievre;
 *
 * $Id: CategoryPlot.java,v 1.28 2006/01/11 12:10:16 mungady Exp $
 *
 ...
 * 06-Jun-2005 : Fixed equals() for use with GradientPaint (DG);
...
public class CategoryPlot extends Plot
	 ...
	 * using the {@link #mapDatasetToDomainAxis(int, int)} method.
	 * 
	 * @param index
	 *            the dataset index.
	 * 
	 ...
	 * using the {@link #mapDatasetToRangeAxis(int, int)} method.
	 * 
	 * @param index
	 *            the dataset index.
	 * 
	...
	/**
	 * Returns the renderer for the specified dataset. If the dataset doesn't belong
	 * to the plot, this method will return <code>null</code>.
	 * 
	 * @param dataset
	 *            the dataset (<code>null</code> permitted).
	 * 
	...
	/**
	 * Sets the stroke used to draw the grid-lines against the range axis and sends
	 ...
	 * be drawn by the renderer as a line perpendicular to the domain axis, however
	 ...
	 *            the axis.
	 * 
	 * @return The edge or <code>null</code> if the axis isn't recognised.
	 */
	public RectangleEdge getAxisEdge(CategoryAxis axis) {
		RectangleEdge result = null;
	 ...
	 *            the area.
	 * @param params
	 *            optional parameters (ignored at present).
	 * 
	 * @return The result from drawing (currently <code>null</code>).
	 */
	...
	public void draw(Graphics2D g2, Rectangle2D area, Point2D anchor, PlotState parentState, PlotRenderingInfo state) {
		...
		Rectangle2D dataArea = area; // space.shrink(plotArea, null);
	...
	public void drawDataArea(Graphics2D g2, Rectangle2D area) {
		draw(g2, area, null, null, null);
	}
	...
	protected void drawRangeGridlines(Graphics2D g2, Rectangle2D dataArea) {
		...
		List ticks = getRangeAxis(0).getTicks();
	...
	/**
	 * This method does nothing, because <code>CategoryPlot</code> doesn't support
	 * zooming on the domain.
	 *
	 * @param factor
	 *            the zoom factor.
	 * @param state
