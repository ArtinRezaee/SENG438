...
public class BlockParams implements EntityBlockParams {
	...
	/**
	 * The x-translation (used to enable chart entities to use global coordinates
	 * rather than coordinates that are local to the container they are within).
	 */
	private double translateX;

	/**
	 * The y-translation (used to enable chart entities to use global coordinates
	 * rather than coordinates that are local to the container they are within).
	 */
	...
	/**
	 * Returns the translation required to convert local x-coordinates back to the
	...
	/**
	 * Returns the translation required to convert local y-coordinates back to the
	 * coordinate space of the container.
	 * 
