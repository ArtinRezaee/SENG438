 ...
 * Contributor(s):   -;
 *
 * $Id: LegendGraphic.java,v 1.14 2005/11/16 10:19:02 mungady Exp $
 *
 * Changes
 * -------
 ...
 * 05-Sep-2005 : Implemented PublicCloneable (DG);
 * 
 */
 ...
 */
public class LegendGraphic extends AbstractContentBlock implements PublicCloneable {
	...
	/**
	 * Defines the point on the shape's bounding rectangle that will be aligned to
	 * the drawing location when the shape is rendered.
	 */
	...
	/**
	 * Sets the shape anchor. This defines a point on the shapes bounding rectangle
	 * that will be used to align the shape to a location.
	 * 
	 * @param anchor
	...
	/**
	 * Sets the shape location. This defines a point within the drawing area that
	 * will be used to align the shape to.
	 * 
	 * @param location
	...
	public void draw(Graphics2D g2, Rectangle2D area) {
		...
		if (this.lineVisible) {
			...
			Shape aLine = ShapeUtilities.createTranslatedShape(getLine(), this.shapeAnchor, location.getX(),
					location.getY());
		...
		if (this.shapeVisible) {
			...
			Shape s = ShapeUtilities.createTranslatedShape(this.shape, this.shapeAnchor, location.getX(),
					location.getY());
			if (this.shapeFilled) {
