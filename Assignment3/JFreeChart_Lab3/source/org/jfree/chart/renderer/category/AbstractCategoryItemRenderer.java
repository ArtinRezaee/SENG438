 ...
 *
 * $Id: AbstractCategoryItemRenderer.java,v 1.21 2006/03/08 16:34:09 mungady Exp $
 *
 * Changes:
 * --------
...
public abstract class AbstractCategoryItemRenderer extends AbstractRenderer
	...
	/**
	 * Creates a new renderer with no tool tip generator and no URL generator. The
	 * defaults (no tool tip or URL generators) have been chosen to minimise the
	 ...
	 * This method returns <code>1</code>, subclasses should override if they need
	 * more passes.
	 * 
	...
	/**
	 * Returns the item label generator for a data item. This implementation simply
	...
	/**
	 * Calculates the (x, y) coordinates for drawing the label for a marker on the
	 * range axis.
	 * 
	 * @param g2
	 *            the graphics device.
	 ...
	 */
	private Point2D calculateDomainMarkerTextAnchorPoint(Graphics2D g2, PlotOrientation orientation,
	...
	/**
	 * Returns an independent copy of the renderer. The <code>plot</code> reference
	 * is shallow copied.
	 * 
	 * @return A clone.
	 * 
	...
	/**
	 * Adds an entity with the specified hotspot, but only if an entity collection
	 * is accessible via the renderer state.
	 * 
	 * @param entities
	...
	protected void addItemEntity(EntityCollection entities, CategoryDataset dataset, int row, int column,
		...
		CategoryItemEntity entity = new CategoryItemEntity(hotspot, tip, url, dataset, row,
