 ...
 *
 * $Id: BarRenderer.java,v 1.18 2006/01/11 12:10:16 mungady Exp $
 *
 * Changes
 * -------
...
public class BarRenderer extends AbstractCategoryItemRenderer implements Cloneable, PublicCloneable, Serializable {
	...
	/**
	 * A flag that controls whether the base value is included in the range returned
	 * by the findRangeBounds() method.
	 */
	...
	/**
	 * Returns the flag that controls whether or not the base value for the bars is
	...
	/**
	 * Returns the lower clip value. This value is recalculated in the initialise()
	 * method.
	 *
	 * @return The value.
	 */
	...
	/**
	 * Returns the upper clip value. This value is recalculated in the initialise()
	 * method.
	 *
	 * @return The value.
	 */
	 ...
	 * subsequent calls to the drawItem method. This method gets called once at the
	 * start of the process of drawing a chart.
	 *
	 * @param g2
	 *            the graphics device.
	 * @param dataArea
	 ...
	 * from the specified dataset. This takes into account the range of values in
	 * the dataset, plus the flag that determines whether or not the base value for
	 * the bars should be included in the range.
	 * 
	 * @param dataset
	...
	public LegendItem getLegendItem(int datasetIndex, int series) {
		...
		return new LegendItem(label, description, toolTipText, urlText, true, shape, true, paint, isDrawBarOutline(),
				outlinePaint, outlineStroke, false, new Line2D.Float(), new BasicStroke(1.0f), Color.black);
	}
