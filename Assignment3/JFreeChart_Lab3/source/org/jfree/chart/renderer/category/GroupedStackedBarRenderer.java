 ...
 * Contributor(s):   -;
 *
 * $Id: GroupedStackedBarRenderer.java,v 1.8 2005/09/30 11:03:43 mungady Exp $
 *
 * Changes
 * -------
...
public class GroupedStackedBarRenderer extends StackedBarRenderer implements Cloneable, PublicCloneable, Serializable {
	...
	/**
	 * Calculates the bar width and stores it in the renderer state. We override the
	 * method in the base class to take account of the series-to-group mapping.
	 * 
	 * @param plot
	 *            the plot.
	 * @param dataArea
