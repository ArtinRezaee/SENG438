 ...
 *
 * $Id: HighLowRenderer.java,v 1.6 2005/11/01 11:46:00 mungady Exp $
 *
 * Changes
 * -------
...
public class HighLowRenderer extends AbstractXYItemRenderer
	...
	/**
	 * The paint used for the open ticks (if <code>null</code>, the series paint is
	 * used instead).
	 */
	private transient Paint openTickPaint;

	/**
	 * The paint used for the close ticks (if <code>null</code>, the series paint is
	 * used instead).
	 */
	 ...
	 * {@link RendererChangeEvent} to all registered listeners. If you set this to
	 * <code>null</code> (the default), the series paint is used instead.
	 * 
	 * @param paint
