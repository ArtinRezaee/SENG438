...
public interface XYItemRenderer extends LegendItemSource {
	 ...
	 * passes control to the getSeriesOutlineStroke method. You can override this
	...
	/**
	 * Adds an annotation and sends a {@link RendererChangeEvent} to all registered
	 * listeners. The annotation is added to the foreground layer.
	 * 
	 * @param annotation
	...
	/**
	 * Removes the specified annotation and sends a {@link RendererChangeEvent} to
	 * all registered listeners.
	 * 
	 * @param annotation
	 *            the annotation to remove (<code>null</code> not permitted).
	 * 
	 * @return A boolean to indicate whether or not the annotation was successfully
	 *         removed.
	 */
	 ...
	 *            the stroke (<code>null</code> not permitted).
	 */
	public void drawRangeLine(Graphics2D g2, XYPlot plot, ValueAxis axis, Rectangle2D dataArea, double value,
	...
	/**
	 * Sets the plot that this renderer is assigned to. This method will be called
	 * by the plot class...you do not need to call it yourself.
	 *
	 * @param plot
	 *            the plot.
	 */
	...
	/**
	 * Returns the lower and upper bounds (range) of the x-values in the specified
	 * dataset.
	 * 
	 * @param dataset
	...
	/**
	 * Returns the lower and upper bounds (range) of the y-values in the specified
	 * dataset. The implementation of this method will take into account the
	 * presentation used by the renderers (for example, a renderer that "stacks"
	 * values will return a bigger range than a renderer that doesn't.
	 * 
	 * @param dataset
	 *            the dataset (<code>null</code> permitted).
	 * 
