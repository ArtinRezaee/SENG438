 ...
 *
 * $Id: XYBubbleRenderer.java,v 1.12 2006/01/26 16:12:37 mungady Exp $
 *
 * Changes
 * -------
...
public class XYBubbleRenderer extends AbstractXYItemRenderer
	 ...
	 *
	 * @param scaleType
	 *            the type of scaling (must be one of: {@link #SCALE_ON_BOTH_AXES},
	...
	/**
	 * Returns a legend item for the specified series. The default method is
	 * overridden so that the legend displays circles for all series.
	 *
	 * @param datasetIndex
