 ...
 *
 * $Id: PolarPlot.java,v 1.16 2005/10/25 14:59:09 mungady Exp $
 *
 * Changes
 * -------
...
public class PolarPlot extends Plot
		implements Block, Zoomable, ValueAxisPlot, RendererChangeListener, Cloneable, Serializable {
	 ...
	 * 
	 * @param text
	 *            the text to remove (<code>null</code> ignored).
	 */
	...
	public void draw(Graphics2D g2, Rectangle2D area, Point2D anchor, PlotState parentState, PlotRenderingInfo info) {
		...
		this.axis.arrange(g2, new RectangleConstraint(quadrant.getWidth(), quadrant.getHeight()), null);
		...
		if (this.renderer != null) {
			...
			drawGridlines(g2, dataArea, this.angleTicks, new java.util.ArrayList());
	...
	/**
	 * This method is required by the {@link Zoomable} interface, but since the plot
	 * does not have any domain axes, it does nothing.
	 *
	 * @param factor
	 *            the zoom factor.
	 * @param state
