 ...
 * @author Bryan Scott
 */
public class ThermometerPlot extends Plot implements Block, ValueAxisPlot, Zoomable, Cloneable, Serializable {
	...
	/**
	 * Returns the lower bound for the thermometer. The data value can be set lower
	 * than this, but it will not be shown in the thermometer.
	 *
	...
	/**
	 * Returns the upper bound for the thermometer. The data value can be set higher
	 * than this, but it will not be shown in the thermometer.
	 *
	...
	public void draw(Graphics2D g2, Rectangle2D area, Point2D anchor, PlotState parentState, PlotRenderingInfo info) {
		...
		outerStem.setRoundRect(midX - COLUMN_RADIUS, area.getMinY(), COLUMN_DIAMETER,
		...
		innerStem.setRoundRect(midX - COLUMN_RADIUS + GAP_RADIUS, area.getMinY() + GAP_RADIUS,
		...
		if ((this.dataset != null) && (this.dataset.getValue() != null)) {
			...
			if ((this.rangeAxis != null) && (this.axisLocation != NONE)) {
				...
				case RIGHT:
					this.rangeAxis.arrange(g2, new RectangleConstraint(drawWidth, (stemBottom - stemTop)), null);
					this.rangeAxis.draw(g2, area, RectangleEdge.RIGHT, null);
					break;

				case LEFT:
				default:
					this.rangeAxis.arrange(g2, new RectangleConstraint(drawWidth, (stemBottom - stemTop)), null);
					this.rangeAxis.draw(g2, area, RectangleEdge.LEFT, null);
					break;
				}
	...
	/**
	 * Tests this plot for equality with another object. The plot's dataset is not
	 ...
	 * @param array2
	 *            the second arrray (<code>null</code> permitted).
	 * 
	 * @return A boolean.
	 */
