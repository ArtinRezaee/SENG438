...
public class ChartDeleter implements HttpSessionBindingListener {
	 ...
	 *
	 * @param filename
	 *            the name of the chart in the temporary directory to be deleted.
	 */
	...
	/**
	 * When this object is unbound from the session (including upon session expiry)
	 * the files that have been added to the ArrayList are iterated and deleted.
	 *
	 * @param event
