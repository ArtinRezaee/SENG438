...
public abstract class AbstractCategoryItemLabelGenerator implements PublicCloneable, Cloneable, Serializable {
	 ...
	 * combine the standard items: {0} = series name, {1} = category, {2} = value,
	 * {3} = value as a percentage of the column total.
	 */
	...
	/**
	 * A number formatter used to preformat the percentage value before it is passed
	 * to the MessageFormat object.
	 */
