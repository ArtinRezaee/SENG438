...
public class JDBCXYDataset extends AbstractXYDataset implements XYDataset, TableXYDataset, RangeInfo {
	 ...
	 * database connection. If connection is null then no action is taken.
	 *
	 * The results from the query are extracted and cached locally, thus applying an
	 * upper limit on how many rows can be retrieved successfully.
	 *
	 ...
	 *
	 * @deprecated This method is not used in JFreeChart 1.0.x (it was left in the
	 *             API by mistake and is officially deprecated from version 1.0.3
	 *             onwards).
	 */
