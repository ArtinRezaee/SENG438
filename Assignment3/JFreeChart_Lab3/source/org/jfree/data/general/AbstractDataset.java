...
public abstract class AbstractDataset implements Dataset, Cloneable, Serializable, ObjectInputValidation {
	 ...
	 * {@link DatasetChangeListener} references that have been registered with this
	 * dataset.
	 * 
	 * @return A clone.
	 * 
	 ...
	 * 
	 * This object has registered itself to the system with a priority of 10. Other
	 * callbacks may register with a higher priority number to be called before this
	 * object, or with a lower priority number to be called after the listeners were
	 * notified.
	 * 
