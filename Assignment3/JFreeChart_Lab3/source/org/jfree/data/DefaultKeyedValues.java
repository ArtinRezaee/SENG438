...
public class DefaultKeyedValues implements KeyedValues, Cloneable, PublicCloneable, Serializable {
	...
	/**
	 * Adds a new value to the collection, or updates an existing value. This method
	 * passes control directly to the {@link #setValue(Comparable, Number)} method.
	 *
	 * @param key
	 *            the key (<code>null</code> not permitted).
	 * @param value
	...
	/**
	 * Removes a value from the collection. If there is no item with the specified
