 ...
 *
 * $Id: DynamicTimeSeriesCollection.java,v 1.11 2005/05/20 08:20:03 mungady Exp $
 *
 * Changes
 * -------
...
public class DynamicTimeSeriesCollection extends AbstractIntervalXYDataset
	 ...
	 * return if the time array was already populated.
	 *
	 * Also computes the data cached for later use by methods implementing the
	...
	/**
	 * Finds the domain limits. Note: this doesn't need to be synchronized because
	 * it's called from within another method that already is.
	 */
	 ...
	 *            the series key.
	 *
	 *            Use this as-is during setup only, or add the synchronized keyword
	 *            around the copy loop.
	 */
	 ...
	 * super.getXValue(series, item); }
	 * 
	 * public float getUntranslatedY(int series, int item) { return
	 * super.getY(series, item); }
	 */
