...
/**
 * A dataset for regular time periods that implements the {@link TableXYDataset}
 * interface.
 * 
...
public class TimeTableXYDataset extends AbstractIntervalXYDataset
	...
	/**
	 * The data structure to store the values. Each column represents a series
	 * (elsewhere in JFreeChart rows are typically used for series, but it doesn't
	 * matter that much since this data structure is private and symmetrical
	 * anyway), each row contains values for the same {@link RegularTimePeriod} (the
	 ...
	 * 
	 * @param zone
	 *            the time zone to use (<code>null</code> not permitted).
	 */
	 ...
	 *            the time zone to use (<code>null</code> not permitted).
	 * @param locale
	 *            the locale to use (<code>null</code> not permitted).
	 */
	 ...
	 * @param y
	 *            the value for this period (<code>null</code> permitted).
	 * @param seriesName
	 *            the name of the series to add the value (<code>null</code> not
	 *            permitted).
	 * @param notify
	 ...
	 * @param seriesName
	 *            the (existing!) series name to remove the value (<code>null</code>
	 *            not permitted).
	 */
	...
	/**
	 * Returns the time period for the specified item. Bear in mind that all series
	 * share the same set of time periods.
	 * 
	 * @param item
	 *            the item index (0 <= i <= {@link #getItemCount()}).
	 * 
