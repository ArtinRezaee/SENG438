 ...
 * Contributor(s):   -;
 *
 * $Id: TimePeriodValuesCollection.java,v 1.10 2005/05/20 08:20:03 mungady Exp $
 *
 * Changes
 * -------
...
public class TimePeriodValuesCollection extends AbstractIntervalXYDataset
	 ...
	 * time'. This flag is used when determining the max and min values for the
	 * domain. If true, then only the x-values are considered for the max and min
	 * values. If false, then the start and end x-values will also be taken into
	 * consideration
	 *
	 * @return The flag.
	 */
	 ...
	 * {@link org.jfree.data.general.DatasetChangeEvent} is sent to all registered
	 * listeners.
	 *
	 * @param series
	 *            the time series.
	 ...
	 *
	 * @param series
	 *            the series to remove (<code>null</code> not permitted).
	 */
