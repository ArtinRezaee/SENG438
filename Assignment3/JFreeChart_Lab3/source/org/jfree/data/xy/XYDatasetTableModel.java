...
/**
 * A READ-ONLY wrapper around a {@link TableXYDataset} to convert it to a table
 * model for use in a JTable. The first column of the table shows the x-values,
 * the remaining columns show the y-values for each series (series 0 appears in
